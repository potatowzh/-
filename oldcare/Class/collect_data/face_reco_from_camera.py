...
from detection import smile_detection
from detection.model import create_model
from detection import facenet_utils

# import detection.smile_detection
...
nn4_small2_pretrained.load_weights('F:\\old\\Intelligent-Elderly-Care-master\\Intelligent-Elderly-Care-master\\Data\\weights\\nn4.small2.v1.h5')
                        ...
                        for k in range(0, faces.shape[2]):
                            ...
                            try:
                                ...
                                if min(e_distance_list) < 0.58:
                                    ...
                                    # if self.type_camera_list[k] == 'person_1':
...
def main():
    ...
    # ffmpeg_writer.ffmpeg_writer.run()
