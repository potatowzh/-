...
class Face_Register:
    def __init__(self, people_type, id):
        self.init = False
        self.path_photos_from_camera = "C:\\Users\\ASUS\\Desktop\\Elderly-Care\\Data\\data_faces_from_camera\\"
    ...
    def pre_work_del_old_face_folders(self):
        ...
        if os.path.isfile("C:\\Users\\ASUS\\Desktop\\Elderly-Care\\Data\\features_all.csv"):
            os.remove("C:\\Users\\ASUS\\Desktop\\Elderly-Care\\Data\\features_all.csv")

    # 如果有之前录入的人脸, 在之前 person_x 的序号按照 person_x+1 开始录入 (v1)
    # 根据传入的人员类型和 id 录入 (v2)
    def check_existing_faces_cnt(self):
        if os.listdir("C:\\Users\\ASUS\\Desktop\\Elderly-Care\\Data\\data_faces_from_camera\\"):
            # 获取已录入的最后一个人脸序号
