...
class Live(object):
    def __init__(self):
        ...
        # opencv dnn 人脸检测器
        self.detector = cv2.dnn.readNetFromCaffe("F:\\old\\Intelligent-Elderly-Care-master\\Intelligent-Elderly-Care-master\\Data\\data_opencv\\deploy.prototxt.txt",
        ...
        self.nn4_small2.load_weights('F:\\old\\Intelligent-Elderly-Care-master\\Intelligent-Elderly-Care-master\\Data\\weights\\nn4.small2.v1.h5')

        # websocket 连接服务器
        # self.ws = create_connection("ws://192.144.229.49:8000/api/websocket/cameraLink")
        self.ws = create_connection("ws://127.0.0.1:8000/api/websocket/cameraLink")

        self.frame_queue = queue.Queue()

        # self.rtmpUrl = "rtmp://39.97.124.237:1984/wodelive"
        self.rtmpUrl = "rtmp://106.14.78.63:1935/rtmplive/123"
        # self.camera_path = "test4.mp4"

        # 人脸搜集
        # self.Face_Register_on = Face_Register(people_type=1, id='3')
        self.Face_Register_on = Face_Register(people_type=0, id='3')
        ...
        # 入侵检测
        self.net = cv2.dnn.readNetFromCaffe('F:\\old\\Intelligent-Elderly-Care-master\\Intelligent-Elderly-Care-master\\Data\\data_opencv\\MobileNetSSD_deploy.prototxt',
                                            'F:\\old\\Intelligent-Elderly-Care-master\\Intelligent-Elderly-Care-master\\Data\\data_opencv\\MobileNetSSD_deploy.caffemodel')
            ...
            if not self.frame_queue.empty():
                ...
                if self.recieve["todo"] == 'reboot':
                    ...
                    if fuc == '0':
                        ...
                        # frame = self.Face_Recognizer_con.run()
