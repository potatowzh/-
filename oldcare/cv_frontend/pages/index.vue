...
<!--                        <strong>Oldcare</strong>-->
<!--                    </span>-->
                    <span style="font-size: 60px;"><br></span>
                    <span style="font-weight: 400; font-size: 48px; color: rgb(255, 255, 255); ">
                        <strong><span class="ub-dynamic">OLDCARE</span></strong>
                    </span>
                </p>
            </div>
        </div>
        ...
        <div style="background-color: transparent">
            ...
            <div  class="login">
                <el-button type="primary" @click="login()"
                           style="width: 20%;border: solid 2px #fff;background-color: transparent;letter-spacing:10px;font-size: 18px;font-weight: bold"
