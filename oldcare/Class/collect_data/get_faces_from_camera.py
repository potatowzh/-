...
class Face_Register:
    def __init__(self, people_type, id):
        self.init = False
        self.path_photos_from_camera = "F:\\old\\Intelligent-Elderly-Care-master\\Intelligent-Elderly-Care-master\\Data\\data_faces_from_camera\\"
    ...
    def check_existing_faces_cnt(self):
        if os.listdir("F:\\old\\Intelligent-Elderly-Care-master\\Intelligent-Elderly-Care-master\\Data\\data_faces_from_camera\\"):
            # 获取已录入的最后一个人脸序号
...
def main():
    #这里只录入1的，即只有员工，通过修改录入不同职位和人
    Face_Register_con = Face_Register(people_type=0, id='1')
